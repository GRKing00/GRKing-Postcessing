...
{
    public class ScreenShakeGlitchRenderPass : ScriptableRenderPass
    {
        private const string m_ProfilerTag = "Screen Shake Glitch";
        private ProfilingSampler m_ProfilingSampler = new ProfilingSampler(m_ProfilerTag);
        
        private ScreenShakeGlitchSettings m_Settings =  new ScreenShakeGlitchSettings();
        ...
        public ScreenShakeGlitchRenderPass(Material mat, RenderPassEvent evt)
        {
            m_Material = mat;
            renderPassEvent = evt;
        }

        public void Setup(float shakeSpeed, float shakeIntensity)
        {
            m_Settings.shakeSpeed = shakeSpeed;
            m_Settings.shakeIntensity = shakeIntensity;
        }
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, m_ProfilingSampler))
            {
                ...
                m_Material.SetVector("_Params",new Vector4(m_Settings.shakeSpeed, m_Settings.shakeIntensity, 0,0));
