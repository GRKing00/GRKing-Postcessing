...
namespace CustomPostcessing.Blur.GrainyBlur
{
    public class GrainyBlurRenderPass : ScriptableRenderPass
    {
        private const string m_ProfilerTag = "GrainyBlurRenderPass";
        private static readonly ProfilingSampler m_ProfilingSampler = new ProfilingSampler(m_ProfilerTag);
        
        private GrainyBlurSettings m_Settings = new GrainyBlurSettings();
        ...
        public GrainyBlurRenderPass(Material mat, RenderPassEvent evt)
        {
            m_Material = mat;
            renderPassEvent = evt;
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, m_ProfilingSampler))
            {
                ...
                m_Material.SetVector("_Params", new Vector4(m_Settings.blurRadius, m_Settings.blurIterations,0,0));
