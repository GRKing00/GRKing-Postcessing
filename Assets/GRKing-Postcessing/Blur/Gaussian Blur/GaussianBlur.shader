Shader "CustomEffects/GaussianBlur"
{
    HLSLINCLUDE
        ...
        half4 BlurFrag (Varyings IN) : SV_Target
        {
        	...
        	finalColor = SAMPLE_TEXTURE2D(_BlitTexture, sampler_BlitTexture, IN.uv) * 6;

        	finalColor += SAMPLE_TEXTURE2D(_BlitTexture, sampler_BlitTexture, IN.uv01.xy) * 4;
        	finalColor += SAMPLE_TEXTURE2D(_BlitTexture, sampler_BlitTexture, IN.uv01.zw) * 4;
