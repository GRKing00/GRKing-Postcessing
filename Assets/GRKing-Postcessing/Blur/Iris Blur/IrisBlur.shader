Shader "CustomEffects/IrisBlur"
{
    HLSLINCLUDE
        ...
        {
            float2 center = uv * 2.0 - 1.0 + _Offset.xy;
            return saturate(pow(dot(center,center) * _Area,_Power));
        }
        ...
        half4 frag (Varyings input) : SV_Target
        {
            ...
            half4 finalColor = lerp(origin,blurRes,IrisMask(input.texcoord));
            return finalColor;
        }
