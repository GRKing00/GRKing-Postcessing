...
{
    public class IrisBlurRenderPass : ScriptableRenderPass
    {
        private const string m_ProfilerTag = "IrisBlurRenderPass";
        private static readonly ProfilingSampler m_ProfilingSampler = new ProfilingSampler(m_ProfilerTag);
        
        private IrisBlurSettings m_Settings = new IrisBlurSettings();
        ...
        public IrisBlurRenderPass(Material mat, RenderPassEvent evt)
        {
            m_Material = mat;
            renderPassEvent = evt;
        ...
        public void Setup(float radius, int iterations, DownSampleMode mode,
            float centerOffsetX, float centerOffsetY, float blurRange, float power)
        {
            m_Settings.blurRadius =  radius;
            m_Settings.blurIterations = iterations;
            m_Settings.RTDownScale = mode;
            m_Settings.centerOffsetX = centerOffsetX;
            m_Settings.centerOffsetY = centerOffsetY;
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, m_ProfilingSampler))
            {
                ...
                m_Material.SetVector("_Offset",new Vector4(m_Settings.centerOffsetX,m_Settings.centerOffsetY,0,0));
